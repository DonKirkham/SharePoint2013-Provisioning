...
namespace TekFocus.ProvisioningDemoWeb.Pages
{
    public partial class Branding : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.ClientScript.RegisterClientScriptBlock(typeof(Branding), "BasePageScript", script, true);
        }

        public void btnDeployTemplates_Click(object sender, EventArgs e)
        {
        ...
        public void btnTemplatesDelete_Click(object sender, EventArgs e)
        {
            var spContext = SharePointContextProvider.Current.GetSharePointContext(Context);
            using (var clientContext = spContext.CreateUserClientContextForSPHost())
            {
        ...
        {
            string fileURL = string.Format("Branding/Template Demo/Masterpages/{0}", masterPageURL);
        ...
        private void CreatePage(ClientContext clientContext, Web web, string pageName, string templateName, string serverRelatedURL)
        {
            ...
            System.IO.StreamReader pageTemplate = new System.IO.StreamReader(HostingEnvironment.MapPath(string.Format("~/{0}", "Branding/Template Demo/Templates/PageTemplate.txt")));
            ...
            System.IO.StreamReader webpartTemplate = new System.IO.StreamReader(HostingEnvironment.MapPath(string.Format("~/Branding/Template Demo/Templates/{0}", templateName)));
        ...
        {
            string fileURL = string.Format("Branding/Template Demo/Scripts/{0}", jsURL);
        ...
        {
            string fileURL = "Branding/Template Demo/Scripts/HomePageHeroItemTemplate.js";
        ...
        {
            UploadImagesToDocumentLibrary(web, HostingEnvironment.MapPath(string.Format("~/{0}", "Branding/Template Demo/Images/example-slide-1.jpg")));
            UploadImagesToDocumentLibrary(web, HostingEnvironment.MapPath(string.Format("~/{0}", "Branding/Template Demo/Images/example-slide-2.jpg")));
            UploadImagesToDocumentLibrary(web, HostingEnvironment.MapPath(string.Format("~/{0}", "Branding/Template Demo/Images/example-slide-3.jpg")));
            UploadImagesToDocumentLibrary(web, HostingEnvironment.MapPath(string.Format("~/{0}", "Branding/Template Demo/Images/example-slide-4.jpg")));
        ...
        private void UploadFilesForHeroControl(ClientContext clientContext, Web web, string serverRelatedURL)
        {
            ...
            //Upload files 
            UploadFilesToLibary(clientContext, web, list, "Branding/Template Demo/CSS/hero_desktop.css", string.Format("{0}/Style%20Library/hero/css/hero_desktop.css", serverRelatedURL));
            UploadFilesToLibary(clientContext, web, list, "Branding/Template Demo/CSS/hero_rwd.css", string.Format("{0}/Style%20Library/hero/css/hero_rwd.css", serverRelatedURL));
            UploadFilesToLibary(clientContext, web, list, "Branding/Template Demo/CSS/hero_ipad.css", string.Format("{0}/Style%20Library/hero/css/hero_ipad.css", serverRelatedURL));
            UploadFilesToLibary(clientContext, web, list, "Branding/Template Demo/CSS/hero_iphone.css", string.Format("{0}/Style%20Library/hero/css/hero_iphone.css", serverRelatedURL));
            UploadFilesToLibary(clientContext, web, list, "Branding/Template Demo/Images/Hero-nav-control-circle-blue.png", string.Format("{0}/Style%20Library/hero/images/Hero-nav-control-circle-blue.png", serverRelatedURL));
            UploadFilesToLibary(clientContext, web, list, "Branding/Template Demo/Images/Hero-nav-control-circle-white.png", string.Format("{0}/Style%20Library/hero/images/Hero-nav-control-circle-white.png", serverRelatedURL));

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteCreation.aspx.cs" Inherits="TekFocus.ProvisioningDemoWeb.Pages.SiteCreation" %>
                ...
                <asp:MultiView ID="processViews" runat="server" ActiveViewIndex="0">
                    <asp:View ID="RequestView" runat="server">
                        <div style="width: 450px; margin-left: 50px;">
                            ...
                            <div id="divFieldEmailToNotify">
                                <h3 class="ms-core-form-line">Give email to notify when request has been processed</h3>
                                <div class="ms-core-form-line">
                                    <asp:TextBox ID="txtEmailToNotify" runat="server" CssClass="ms-fullWidth"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div style="width: 450px; margin-left: 50px;">
                            <div id="divFieldTemplate" style="display: table; width: 100%;">
                                ...
                                <div class="ms-core-form-line">
                                    ...
                                    <br />
                                    Email to notify -
                                    <asp:Label runat="server" ID="lblEmailToNotify" />
                                    <br />
                                    ...
                                    <br />
                                    Notice that requestor will be set as the site collection owner automatically. 
                                </div>
                                <div id="divButtons" style="float: right;">

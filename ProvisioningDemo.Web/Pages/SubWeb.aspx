<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubWeb.aspx.cs" Inherits="TekFocus.ProvisioningDemoWeb.Pages.SubWeb" %>
...
<body style="display:none; overflow: auto;">
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="update" runat="server" ChildrenAsTriggers="true">
                <ContentTemplate>
                    <div style="width: 450px; margin-left:50px; margin-top: -10px;">
                        <div id="divFieldTitle" style="padding-top:15px">
                        ...
                        <div id="divFieldDescription" style="padding-top:5px">
                        ...
                        <div id="divFieldUrl" style="padding-top:5px">
                            <h3 class="ms-core-form-line">URL name</h3>
                            <div style="float: left; white-space: nowrap; padding-bottom: 15px; width: 450px;">
                                <div style="font-size: 13px; float: left; padding-top: 2px;" id="divBasePath">
                        ...
                        <div id="divFieldTemplate" style="display: table; width: 100%; padding-top: 5px">
                            <h3 class="ms-core-form-line">Pick a template</h3>
                            <div class="ms-core-form-line">
                                <asp:ListBox ID="listSites" runat="server" CssClass="ms-fullWidth"></asp:ListBox>
                            </div>
                        </div>
                        <div id="divButtons" style="float: right; padding-top:5px">
